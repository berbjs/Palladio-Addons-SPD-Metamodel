...
import spd.triggers.IdleTimeTrigger;
import spd.triggers.THRESHOLDDIRECTION;
import spd.triggers.TriggersPackage;

/**
 * This is the item provider adapter for a {@link spd.triggers.IdleTimeTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdleTimeTriggerItemProvider extends TimeBasedTriggerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TriggersPackage.Literals.IDLE_TIME_TRIGGER__RESOURCE_CONTAINER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		THRESHOLDDIRECTION labelValue = ((IdleTimeTrigger)object).getThresholdDirection();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_IdleTimeTrigger_type") :
			getString("_UI_IdleTimeTrigger_type") + " " + label;
	}
