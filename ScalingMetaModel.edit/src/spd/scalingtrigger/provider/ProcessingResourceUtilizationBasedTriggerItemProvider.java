...
public class ProcessingResourceUtilizationBasedTriggerItemProvider extends ResourceUtilizationBasedTriggerItemProvider {
	...
	public String getText(Object object) {
		ProcessingResourceUtilizationBasedTrigger processingResourceUtilizationBasedTrigger = (ProcessingResourceUtilizationBasedTrigger)object;
		return getString("_UI_ProcessingResourceUtilizationBasedTrigger_type") + " " + processingResourceUtilizationBasedTrigger.getThreshold();
	}
