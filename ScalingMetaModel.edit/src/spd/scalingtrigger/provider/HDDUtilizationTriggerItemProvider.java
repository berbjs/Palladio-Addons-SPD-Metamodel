...
public class HDDUtilizationTriggerItemProvider extends ProcessingResourceUtilizationBasedTriggerItemProvider {
	...
	public String getText(Object object) {
		HDDUtilizationTrigger hddUtilizationTrigger = (HDDUtilizationTrigger)object;
		return getString("_UI_HDDUtilizationTrigger_type") + " " + hddUtilizationTrigger.getThreshold();
	}
