...
/**
 * This is the item provider adapter for a {@link de.unistuttgart.sqa.slingshot.spd.SPD} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SPDItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SPD_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SPD_name_feature", "_UI_SPD_type"),
				 SpdPackage.Literals.SPD__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpdPackage.Literals.SPD__SCALINGPOLICY);
			childrenFeatures.add(SpdPackage.Literals.SPD__TARGET_GROUPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpdPackage.Literals.SPD__SCALINGPOLICY,
				 SpdFactory.eINSTANCE.createScalingPolicy()));

		newChildDescriptors.add
			(createChildParameter
				(SpdPackage.Literals.SPD__TARGET_GROUPS,
				 TargetsFactory.eINSTANCE.createTargetGroup()));
	}
