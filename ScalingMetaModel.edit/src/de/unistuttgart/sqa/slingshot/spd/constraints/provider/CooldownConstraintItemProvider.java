...
/**
 * This is the item provider adapter for a {@link de.unistuttgart.sqa.slingshot.spd.constraints.CooldownConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.COOLDOWN_CONSTRAINT__COOLDOWN_TIME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConstraintsPackage.Literals.COOLDOWN_CONSTRAINT__MAX_SCALING_OPERATIONS,
				 true,
				 false,
				 false,
