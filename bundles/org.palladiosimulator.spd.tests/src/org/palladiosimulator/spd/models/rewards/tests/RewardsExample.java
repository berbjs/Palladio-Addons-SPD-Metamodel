...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>rewards</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RewardsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(RewardsPackage.eNS_URI, RewardsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.rewards"));
				exponentialSloReward root = RewardsFactory.eINSTANCE.createexponentialSloReward();
