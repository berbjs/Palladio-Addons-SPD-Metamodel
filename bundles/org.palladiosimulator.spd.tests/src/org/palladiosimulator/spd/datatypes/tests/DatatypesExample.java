...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>datatypes</b></em>' package. <!--
 * end-user-doc -->
 * @generated
 */
public class DatatypesExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(DatatypesPackage.eNS_URI, DatatypesPackage.eINSTANCE);
