...
public abstract class TemporalConstraintTest extends AbstractConstraintTest {
    ...
    /**
     * Constructs a new Temporal Constraint test case with the given name. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    public TemporalConstraintTest(final String name) {
        super(name);
    }

    /**
     * Returns the fixture for this Temporal Constraint test case. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    @Override
    protected TemporalConstraint getFixture() {
        return (TemporalConstraint) this.fixture;
    }
