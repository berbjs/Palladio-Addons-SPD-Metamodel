...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>policy</b></em>' package. <!--
 * end-user-doc -->
 *
 * @generated
 */
public class PolicyExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(PolicyPackage.eNS_URI, PolicyPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.policy"));
                final IntervalConstraint root = PolicyFactory.eINSTANCE.createIntervalConstraint();
