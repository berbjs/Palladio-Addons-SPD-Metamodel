...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>target</b></em>' package. <!--
 * end-user-doc -->
 * @generated
 */
public class TargetExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(TargetPackage.eNS_URI, TargetPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.target"));
				TargetGroupSizeConstraint root = TargetFactory.eINSTANCE.createTargetGroupSizeConstraint();
