...
public class TargetExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(TargetPackage.eNS_URI, TargetPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.target"));
                final TargetGroupSizeConstraint root = TargetFactory.eINSTANCE.createTargetGroupSizeConstraint();
