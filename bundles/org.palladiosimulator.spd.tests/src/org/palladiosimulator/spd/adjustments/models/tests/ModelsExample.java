...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>models</b></em>' package. <!--
 * end-user-doc -->
 *
 * @generated
 */
public class ModelsExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(ModelsPackage.eNS_URI, ModelsPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.models"));
                final QThresholdsModel root = ModelsFactory.eINSTANCE.createQThresholdsModel();
