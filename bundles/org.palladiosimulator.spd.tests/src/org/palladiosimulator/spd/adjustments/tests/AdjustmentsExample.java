...
public class AdjustmentsExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(AdjustmentsPackage.eNS_URI, AdjustmentsPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.adjustments"));
                final RelativeAdjustment root = AdjustmentsFactory.eINSTANCE.createRelativeAdjustment();
