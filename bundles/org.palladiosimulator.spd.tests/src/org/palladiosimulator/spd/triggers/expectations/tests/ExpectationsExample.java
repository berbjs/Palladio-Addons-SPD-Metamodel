...
public class ExpectationsExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(ExpectationsPackage.eNS_URI, ExpectationsPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.expectations"));
                final NoExpectation root = ExpectationsFactory.eINSTANCE.createNoExpectation();
