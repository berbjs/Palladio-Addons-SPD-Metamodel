...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>expectations</b></em>' package. <!--
 * end-user-doc -->
 * @generated
 */
public class ExpectationsExample {
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(ExpectationsPackage.eNS_URI, ExpectationsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.expectations"));
				NoExpectation root = ExpectationsFactory.eINSTANCE.createNoExpectation();
