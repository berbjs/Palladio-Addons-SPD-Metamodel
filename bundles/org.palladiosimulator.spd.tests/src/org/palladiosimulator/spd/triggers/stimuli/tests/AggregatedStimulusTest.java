...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Aggregated Stimulus</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class AggregatedStimulusTest extends StimulusTest {
	...
	/**
	 * Constructs a new Aggregated Stimulus test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public AggregatedStimulusTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Aggregated Stimulus test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected AggregatedStimulus getFixture() {
		return (AggregatedStimulus) fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(StimuliFactory.eINSTANCE.createAggregatedStimulus());
	}
