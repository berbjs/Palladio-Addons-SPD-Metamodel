...
public class StimuliExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(StimuliPackage.eNS_URI, StimuliPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.stimuli"));
                final OperationResponseTime root = StimuliFactory.eINSTANCE.createOperationResponseTime();
