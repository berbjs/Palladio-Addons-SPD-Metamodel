...
public class TriggersExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(TriggersPackage.eNS_URI, TriggersPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.triggers"));
                final ComposedTrigger root = TriggersFactory.eINSTANCE.createComposedTrigger();
