...
/**
 * This is the central singleton for the SPDModelReward editor plugin. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public final class SPDModelRewardEditorPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public static final SPDModelRewardEditorPlugin INSTANCE = new SPDModelRewardEditorPlugin();
     ...
     * @generated
     */
    public SPDModelRewardEditorPlugin() {
