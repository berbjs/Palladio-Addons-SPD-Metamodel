...
/**
 * This is the action bar contributor for the Spdmodelreward model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class SpdmodelrewardActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                SpdmodelrewardActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
            SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return SpdmodelrewardActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (SpdmodelrewardActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) SpdmodelrewardActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public SpdmodelrewardActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator("spdmodelreward-settings"));
        toolBarManager.add(new Separator("spdmodelreward-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_SpdmodelrewardEditor_menu"),
                "org.palladiosimulator.spdmodelrewardMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void setActiveEditor(final IEditorPart part) {
        ...
        if (part == null) {
            ...
            this.selectionProvider = part.getSite()
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(SPDModelRewardEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
