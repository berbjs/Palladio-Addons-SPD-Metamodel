...
/**
 * This is the action bar contributor for the Targets model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class TargetsActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                TargetsActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return TargetsActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (TargetsActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) TargetsActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
