...
/**
 * This is the action bar contributor for the Target model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class TargetActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                TargetActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return TargetActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (TargetActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) TargetActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ScalingPolicyDefinitionEditorPlugin.INSTANCE.getString("_UI_TargetEditor_menu"),
                "org.palladiosimulator.spd.constraints.targetMenuID");
