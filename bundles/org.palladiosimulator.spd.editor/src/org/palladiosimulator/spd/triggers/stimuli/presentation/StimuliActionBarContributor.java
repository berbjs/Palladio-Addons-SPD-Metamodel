...
/**
 * This is the action bar contributor for the Stimuli model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class StimuliActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                StimuliActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return StimuliActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (StimuliActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) StimuliActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
