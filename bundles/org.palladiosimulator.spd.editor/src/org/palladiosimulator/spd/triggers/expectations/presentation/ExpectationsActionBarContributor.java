...
/**
 * This is the action bar contributor for the Expectations model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class ExpectationsActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                ExpectationsActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return ExpectationsActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ExpectationsActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ExpectationsActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
