...
/**
 * This is the action bar contributor for the Models model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class ModelsActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                ModelsActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return ModelsActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ModelsActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ModelsActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
     ...
     * @generated
     */
    public ModelsActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator("models-settings"));
        toolBarManager.add(new Separator("models-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ...
                "org.palladiosimulator.spd.adjustments.modelsMenuID");
