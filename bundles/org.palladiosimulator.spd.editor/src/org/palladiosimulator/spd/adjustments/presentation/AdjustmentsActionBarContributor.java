 ...
 * @generated
 */
public class AdjustmentsActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        @Override
        public void run() {
            if (AdjustmentsActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) AdjustmentsActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ScalingPolicyDefinitionEditorPlugin.INSTANCE.getString("_UI_AdjustmentsEditor_menu"),
                "org.palladiosimulator.spd.adjustmentsMenuID");
