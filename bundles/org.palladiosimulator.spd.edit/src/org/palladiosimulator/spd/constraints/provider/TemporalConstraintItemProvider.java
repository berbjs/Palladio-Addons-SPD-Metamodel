...
public class TemporalConstraintItemProvider extends AbstractConstraintItemProvider {
	...
	public String getText(Object object) {
		String label = ((TemporalConstraint) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_TemporalConstraint_type")
				: getString("_UI_TemporalConstraint_type") + " " + label;
	}
