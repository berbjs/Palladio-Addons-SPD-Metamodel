...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.spd.constraints.policy.PolicyConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolicyConstraintItemProvider extends AbstractConstraintItemProvider {
	...
	public String getText(Object object) {
		String label = ((PolicyConstraint) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_PolicyConstraint_type")
				: getString("_UI_PolicyConstraint_type") + " " + label;
	}
