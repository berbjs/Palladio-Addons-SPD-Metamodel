...
public class ThrashingConstraintItemProvider extends TemporalConstraintItemProvider {
     ...
     * @generated
     */
    public ThrashingConstraintItemProvider(final AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addMinimumTimeNoThrashingPropertyDescriptor(object);
        }
     ...
     * @generated
     */
    protected void addMinimumTimeNoThrashingPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ThrashingConstraint_minimumTimeNoThrashing_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_ThrashingConstraint_minimumTimeNoThrashing_feature", "_UI_ThrashingConstraint_type"),
                TargetPackage.Literals.THRASHING_CONSTRAINT__MINIMUM_TIME_NO_THRASHING, true, false, false,
    ...
    public String getText(final Object object) {
        final String label = ((ThrashingConstraint) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_ThrashingConstraint_type")
                : this.getString("_UI_ThrashingConstraint_type") + " " + label;
    }
