...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.spd.models.BaseModel} object.
...
public class BaseModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInitalIntervalDelayPropertyDescriptor(object);
		}
	...
	protected void addIntervalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BaseModel_interval_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BaseModel_interval_feature",
								"_UI_BaseModel_type"),
	...
	/**
	 * This adds a property descriptor for the Inital Interval Delay feature.
	 * <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitalIntervalDelayPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BaseModel_initalIntervalDelay_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BaseModel_initalIntervalDelay_feature",
								"_UI_BaseModel_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_BaseModel_type") + " " + baseModel.getInterval();
	}
