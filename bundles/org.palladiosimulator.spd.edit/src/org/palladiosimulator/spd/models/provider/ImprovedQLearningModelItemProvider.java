...
public class ImprovedQLearningModelItemProvider extends LearningBasedModelItemProvider {
	...
	public String getText(Object object) {
		ImprovedQLearningModel improvedQLearningModel = (ImprovedQLearningModel) object;
		return getString("_UI_ImprovedQLearningModel_type") + " " + improvedQLearningModel.getInterval();
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == ModelsPackage.Literals.LEARNING_BASED_MODEL__INPUTS
