...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.spd.triggers.stimuli.Stimulus} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class StimulusItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public StimulusItemProvider(AdapterFactory adapterFactory) {
	...
	protected String getRoleText(final Object object) {
		...
		if (stimulus.eContainingFeature() != null
				&& stimulus.eContainer().eContents().stream().filter(Stimulus.class::isInstance).count() > 1
				&& stimulus.eContainingFeature().getName() != null
				&& stimulus.eContainingFeature().getName().length() != 0) {
			return " AS " + stimulus.eContainingFeature().getName();
		}
		return "";
	}
