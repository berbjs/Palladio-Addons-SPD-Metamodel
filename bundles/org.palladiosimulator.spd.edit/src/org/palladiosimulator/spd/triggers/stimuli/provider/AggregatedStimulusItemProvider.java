...
public class AggregatedStimulusItemProvider extends StimulusItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addAggregationMethodPropertyDescriptor(object);
    ...
    /**
     * This adds a property descriptor for the Aggregation Method feature. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addAggregationMethodPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_AggregatedStimulus_aggregationMethod_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_AggregatedStimulus_aggregationMethod_feature",
