...
public class ExpectedPercentageItemProvider extends ExpectedPrimitiveItemProvider {
     ...
     * @generated
     */
    public ExpectedPercentageItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addValuePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_ExpectedPercentage_value_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ExpectedPercentage_value_feature",
    ...
    /**
     * This returns ExpectedPercentage.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/ExpectedPercentage"));
    }
    ...
    public String getText(final Object object) {
        final ExpectedPercentage expectedPercentage = (ExpectedPercentage) object;
        return this.getString("_UI_ExpectedPercentage_type") + " " + expectedPercentage.getValue();
    }
