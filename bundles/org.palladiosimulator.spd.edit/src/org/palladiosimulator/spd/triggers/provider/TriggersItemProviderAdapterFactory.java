...
public class TriggersItemProviderAdapterFactory extends TriggersAdapterFactory
     ...
     * {@link org.palladiosimulator.spd.triggers.ComposedTrigger} instances. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createComposedTriggerAdapter() {
        if (this.composedTriggerItemProvider == null) {
            this.composedTriggerItemProvider = new ComposedTriggerItemProvider(this);
        }

        return this.composedTriggerItemProvider;
    }

    /**
     * This keeps track of the one adapter used for all
     * {@link org.palladiosimulator.spd.triggers.SimpleFireOnValue} instances. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createSimpleFireOnValueAdapter() {
        if (this.simpleFireOnValueItemProvider == null) {
            this.simpleFireOnValueItemProvider = new SimpleFireOnValueItemProvider(this);
        }

        return this.simpleFireOnValueItemProvider;
    }

    /**
     * This keeps track of the one adapter used for all
     * {@link org.palladiosimulator.spd.triggers.SimpleFireOnTrend} instances. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createSimpleFireOnTrendAdapter() {
        if (this.simpleFireOnTrendItemProvider == null) {
            this.simpleFireOnTrendItemProvider = new SimpleFireOnTrendItemProvider(this);
        }

        return this.simpleFireOnTrendItemProvider;
    }
    ...
    public void dispose() {
        if (this.composedTriggerItemProvider != null) {
            this.composedTriggerItemProvider.dispose();
        }
        if (this.simpleFireOnValueItemProvider != null) {
            this.simpleFireOnValueItemProvider.dispose();
        }
        if (this.simpleFireOnTrendItemProvider != null) {
            this.simpleFireOnTrendItemProvider.dispose();
        }
    }
