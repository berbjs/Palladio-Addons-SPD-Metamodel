 ...
 * {@link org.palladiosimulator.spd.adjustments.models.RandomModel} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class RandomModelItemProvider extends BaseModelItemProvider {
    ...
    public String getText(final Object object) {
        final String label = ((RandomModel) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_RandomModel_type")
                : this.getString("_UI_RandomModel_type") + " " + label;
    }
