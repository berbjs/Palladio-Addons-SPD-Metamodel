...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.semanticspd.CompetingConsumersGroupCfg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticspdPackage.Literals.COMPETING_CONSUMERS_GROUP_CFG__UNIT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticspdPackage.Literals.COMPETING_CONSUMERS_GROUP_CFG__ELEMENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SemanticspdPackage.Literals.COMPETING_CONSUMERS_GROUP_CFG__BROKER_ASSEMBLY,
				 true,
				 false,
				 true,
				 null,
