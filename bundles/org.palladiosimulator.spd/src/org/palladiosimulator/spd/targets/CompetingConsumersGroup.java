...
public interface CompetingConsumersGroup extends TargetGroup {
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The unitAssembly of the CompetingConsumersGroup identifies the AssemblyContext which exists in the System model and which shall be replicated upon scaling out. Furthermore, the unit assembly is the one which will exist throughout the simulation independent of the adaptations.
	 * <!-- end-model-doc -->
