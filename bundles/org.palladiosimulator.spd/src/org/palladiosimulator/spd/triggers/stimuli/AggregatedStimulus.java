 ...
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.spd.triggers.stimuli.AggregatedStimulus#getAggregationMethod
...
public interface AggregatedStimulus extends Stimulus {
    /**
     * Returns the value of the '<em><b>Aggregation Method</b></em>' attribute. The literals are
     * from the enumeration {@link org.palladiosimulator.spd.triggers.AGGREGATIONMETHOD}. <!--
     ...
     * <em>Aggregation Method</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Aggregation Method</em>' attribute.
     * @see org.palladiosimulator.spd.triggers.AGGREGATIONMETHOD
