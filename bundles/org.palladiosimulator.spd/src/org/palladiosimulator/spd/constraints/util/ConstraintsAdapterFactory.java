...
public class ConstraintsAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ConstraintsSwitch<Adapter> modelSwitch = new ConstraintsSwitch<>() {
        ...
        public Adapter caseAbstractConstraint(final AbstractConstraint object) {
            return ConstraintsAdapterFactory.this.createAbstractConstraintAdapter();
        }

        @Override
        public Adapter caseTemporalConstraint(final TemporalConstraint object) {
            return ConstraintsAdapterFactory.this.createTemporalConstraintAdapter();
        }

        @Override
        public Adapter caseStateBasedContraint(final StateBasedContraint object) {
            return ConstraintsAdapterFactory.this.createStateBasedContraintAdapter();
        }

        @Override
        public Adapter caseIdentifier(final Identifier object) {
            return ConstraintsAdapterFactory.this.createIdentifierAdapter();
        }
