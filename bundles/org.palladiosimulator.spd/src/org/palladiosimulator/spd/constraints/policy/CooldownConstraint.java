 ...
 *
 * <!-- begin-model-doc --> The CoolDown constraint defines a quiescence period in which the target
 * group is not enacted by the policy. In addition one can specify the maximum number of scaling
 * operations that can occur in the defined quiescence period. Contrary to the IntervalConstraint,
 * the CooldownConstraint determines the future enactment of the policy after an adjustment has
 * happened. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.palladiosimulator.spd.constraints.policy.CooldownConstraint#getCooldownTime
 * <em>Cooldown Time</em>}</li>
 * <li>{@link org.palladiosimulator.spd.constraints.policy.CooldownConstraint#getMaxScalingOperations
...
public interface CooldownConstraint extends TemporalConstraint, PolicyConstraint {
    /**
     * Returns the value of the '<em><b>Cooldown Time</b></em>' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * <em>Cooldown Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
    ...
    /**
     * Returns the value of the '<em><b>Max Scaling Operations</b></em>' attribute. The default
     ...
     * <em>Max Scaling Operations</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Max Scaling Operations</em>' attribute.
