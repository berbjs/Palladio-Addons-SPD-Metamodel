...
public interface ModelsFactory extends EFactory {
     ...
     * @generated
     */
    ModelsFactory eINSTANCE = org.palladiosimulator.spd.adjustments.models.impl.ModelsFactoryImpl.init();

    /**
     * Returns a new object of class '<em>QThresholds Model</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
