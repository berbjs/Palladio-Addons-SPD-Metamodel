...
public class ModelsSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case ModelsPackage.QTHRESHOLDS_MODEL: {
            ...
            if (result == null) {
                result = this.caseLearningBasedModel(qThresholdsModel);
            }
            if (result == null) {
        ...
        case ModelsPackage.IMPROVED_QLEARNING_MODEL: {
            final ImprovedQLearningModel improvedQLearningModel = (ImprovedQLearningModel) theEObject;
            T result = this.caseImprovedQLearningModel(improvedQLearningModel);
            if (result == null) {
                result = this.caseLearningBasedModel(improvedQLearningModel);
            }
            if (result == null) {
                result = this.caseBaseModel(improvedQLearningModel);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Improved QLearning
     * Model</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null
     * result will terminate the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Improved QLearning
     *         Model</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseImprovedQLearningModel(final ImprovedQLearningModel object) {
        return null;
    }
