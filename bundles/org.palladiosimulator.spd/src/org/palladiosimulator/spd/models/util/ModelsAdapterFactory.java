...
public class ModelsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelsSwitch<Adapter> modelSwitch = new ModelsSwitch<>() {
		...
		@Override
		public Adapter caseQThresholdsModel(QThresholdsModel object) {
			return createQThresholdsModelAdapter();
		}

		@Override
		public Adapter caseRandomModel(RandomModel object) {
			return createRandomModelAdapter();
		}

		@Override
		public Adapter caseImprovedQLearningModel(ImprovedQLearningModel object) {
			return createImprovedQLearningModelAdapter();
		}

		@Override
		public Adapter caseLearningBasedModel(LearningBasedModel object) {
			return createLearningBasedModelAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.spd.models.BaseModel <em>Base Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.spd.models.QThresholdsModel <em>QThresholds Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.spd.models.RandomModel <em>Random Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.spd.models.ImprovedQLearningModel <em>Improved QLearning Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.spd.models.LearningBasedModel <em>Learning Based Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
