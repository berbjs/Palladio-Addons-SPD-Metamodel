...
public interface ModelsPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LEARNING_BASED_MODEL__INPUTS = BASE_MODEL_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QTHRESHOLDS_MODEL__TARGET_RESPONSE_TIME = LEARNING_BASED_MODEL_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QTHRESHOLDS_MODEL__RESPONSE_TIME_STIMULUS = LEARNING_BASED_MODEL_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int QTHRESHOLDS_MODEL__EXPONENTIAL_STEEPNESS = LEARNING_BASED_MODEL_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int QTHRESHOLDS_MODEL__UTILIZATION_STIMULUS = LEARNING_BASED_MODEL_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int IMPROVED_QLEARNING_MODEL__TARGET_RESPONSE_TIME = LEARNING_BASED_MODEL_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int IMPROVED_QLEARNING_MODEL__RESPONSE_TIME_STIMULUS = LEARNING_BASED_MODEL_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int IMPROVED_QLEARNING_MODEL__EXPONENTIAL_STEEPNESS = LEARNING_BASED_MODEL_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int IMPROVED_QLEARNING_MODEL__UTILIZATION_STIMULUS = LEARNING_BASED_MODEL_FEATURE_COUNT + 3;
