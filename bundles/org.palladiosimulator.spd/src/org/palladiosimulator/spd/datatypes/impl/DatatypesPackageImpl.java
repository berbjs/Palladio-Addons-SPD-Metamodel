...
public class DatatypesPackageImpl extends EPackageImpl implements DatatypesPackage {
	...
	public void createPackageContents() {
		...
		// Create data types
		percentDoubleEDataType = createEDataType(PERCENT_DOUBLE);
	...
	public void initializePackageContents() {
		...
		initEDataType(percentDoubleEDataType, double.class, "PercentDouble", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(positiveIntegerEDataType, int.class, "PositiveInteger", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(percentDoubleEDataType, source, new String[] { "maxInclusive", "1.0", "minInclusive", "0.0" });
		addAnnotation(positiveIntegerEDataType, source, new String[] { "minInclusive", "0" });
	}
