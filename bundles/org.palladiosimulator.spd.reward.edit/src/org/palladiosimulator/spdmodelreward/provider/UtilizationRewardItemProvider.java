 ...
 * {@link org.palladiosimulator.spdmodelreward.UtilizationReward} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class UtilizationRewardItemProvider extends BaseRewardItemProvider {
    /**
     ...
     * @generated
     */
    public UtilizationRewardItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(SpdmodelrewardPackage.Literals.UTILIZATION_REWARD__STIMULUS);
        }
    ...
    /**
     * This returns UtilizationReward.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator()
            .getImage("full/obj16/UtilizationReward"));
    }
    ...
    public String getText(final Object object) {
        return this.getString("_UI_UtilizationReward_type");
    }
    ...
    public void notifyChanged(final Notification notification) {
        ...
        switch (notification.getFeatureID(UtilizationReward.class)) {
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(SpdmodelrewardPackage.Literals.UTILIZATION_REWARD__STIMULUS,
