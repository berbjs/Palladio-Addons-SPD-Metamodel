...
import de.unistuttgart.sqa.slingshot.spd.triggers.CPUUtilizationTrigger;
import de.unistuttgart.sqa.slingshot.spd.triggers.HDDUtilizationTrigger;
...
import de.unistuttgart.sqa.slingshot.spd.triggers.PointInTimeTrigger;
...
import de.unistuttgart.sqa.slingshot.spd.triggers.ResourceUtilizationBasedTrigger;
import de.unistuttgart.sqa.slingshot.spd.triggers.ResponseTimeTrigger;
...
import de.unistuttgart.sqa.slingshot.spd.triggers.ThresholdBasedTrigger;
import de.unistuttgart.sqa.slingshot.spd.triggers.TimeBasedTrigger;
...
public class TriggersPackageImpl extends EPackageImpl implements TriggersPackage {
	 ...
	 * @see de.unistuttgart.sqa.slingshot.spd.triggers.TriggersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEEnum(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.class, "AGGREGATIONMETHOD");
		addEEnumLiteral(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.AVERAGE);
		addEEnumLiteral(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.MAX);
		addEEnumLiteral(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.MIN);
		addEEnumLiteral(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.MEDIAN);
		addEEnumLiteral(aggregationmethodEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.AGGREGATIONMETHOD.SUM);

		initEEnum(hddusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.HDDUSAGETYPE.class, "HDDUSAGETYPE");
		addEEnumLiteral(hddusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.HDDUSAGETYPE.READ);
		addEEnumLiteral(hddusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.HDDUSAGETYPE.WRITE);

		initEEnum(networkusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.NETWORKUSAGETYPE.class, "NETWORKUSAGETYPE");
		addEEnumLiteral(networkusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.NETWORKUSAGETYPE.SEND);
		addEEnumLiteral(networkusagetypeEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.NETWORKUSAGETYPE.RECEIVE);

		initEEnum(thresholddirectionEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.THRESHOLDDIRECTION.class, "THRESHOLDDIRECTION");
		addEEnumLiteral(thresholddirectionEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.THRESHOLDDIRECTION.EXCEDEED);
		addEEnumLiteral(thresholddirectionEEnum, de.unistuttgart.sqa.slingshot.spd.triggers.THRESHOLDDIRECTION.UNDERCUT);
	}
