...
import de.unistuttgart.sqa.slingshot.spd.util.SpdValidator;
...
public class SpdPackageImpl extends EPackageImpl implements SpdPackage {
	 ...
	 * @see de.unistuttgart.sqa.slingshot.spd.SpdPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getScalingPolicy_Policyconstraint() {
		return (EReference)scalingPolicyEClass.getEStructuralFeatures().get(5);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getScalingPolicy_Policyconstraint(), theConstraintsPackage.getPolicyConstraint(), null, "policyconstraint", null, 0, -1, ScalingPolicy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(spdEClass, de.unistuttgart.sqa.slingshot.spd.SPD.class, "SPD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSPD_Scalingpolicy(), this.getScalingPolicy(), null, "scalingpolicy", null, 1, -1, de.unistuttgart.sqa.slingshot.spd.SPD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSPD_Name(), ecorePackage.getEString(), "name", null, 0, 1, de.unistuttgart.sqa.slingshot.spd.SPD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSPD_TargetGroups(), theTargetsPackage.getTargetGroup(), null, "targetGroups", null, 1, -1, de.unistuttgart.sqa.slingshot.spd.SPD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
