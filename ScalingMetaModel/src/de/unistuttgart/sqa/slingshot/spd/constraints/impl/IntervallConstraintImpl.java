 ...
 * </p>
 * <ul>
 *   <li>{@link de.unistuttgart.sqa.slingshot.spd.constraints.impl.IntervallConstraintImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link de.unistuttgart.sqa.slingshot.spd.constraints.impl.IntervallConstraintImpl#getIntervallDuration <em>Intervall Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntervallConstraintImpl extends TemporalConstraintImpl implements IntervallConstraint {
	...
	protected EClass eStaticClass() {
		return ConstraintsPackage.Literals.INTERVALL_CONSTRAINT;
	}
	...
	public void setOffset(int newOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintsPackage.INTERVALL_CONSTRAINT__OFFSET, oldOffset, offset));
	}
	...
	public void setIntervallDuration(int newIntervallDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintsPackage.INTERVALL_CONSTRAINT__INTERVALL_DURATION, oldIntervallDuration, intervallDuration));
	}
