 ...
 * @generated
 */
public class TargetgroupSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TargetgroupPackage.TARGET_GROUP: {
				TargetGroup targetGroup = (TargetGroup)theEObject;
				T result = caseTargetGroup(targetGroup);
				if (result == null) result = caseSpd_TargetGroup(targetGroup);
	 ...
	 * @generated
	 */
	public T caseSpd_TargetGroup(spd.TargetGroup object) {
		return null;
	}
